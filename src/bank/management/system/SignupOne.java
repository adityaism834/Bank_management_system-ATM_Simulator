...
public class SignupOne extends JFrame implements ActionListener{
    ...
    SignupOne(){
        ...
        JLabel martial1 = new JLabel("Martial Status:" );
        martial1.setFont(new Font("Raleway",Font.BOLD,20));
        martial1.setBounds(100,390,200,30);
        add(martial1);
     ...
     public void actionPerformed(ActionEvent ae){
         ...
         try{
             if(name.equals("")){
                 ...
                 Conn c = new Conn();
                 String query = "insert into signup values('"+formno+"','"+name+"','"+fname+"','"+dob+"','"+gender+"','"+email+"','"+martial1+"','"+address+"','"+city+"','"+state+"','"+pin+"')";
